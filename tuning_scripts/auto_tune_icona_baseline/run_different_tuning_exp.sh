...
sbatch /work/bd1179/b309170/icon-ml_models/icon-a-ml/run/exp.auto_tune_baseline.run year year_refined_1 # Output in log.auto_tune_baseline.17820065.o
sbatch /work/bd1179/b309170/icon-ml_models/icon-a-ml/run/exp.auto_tune_baseline.run year year_refined_2 # With tweak. Output in log.auto_tune_baseline.13887792.o
